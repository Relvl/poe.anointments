...
const Oil: {[name in keyof typeof OilNames]: OilType} = {
    Clear: {
        name: "Clear oil",
...
const Passives: {[name in keyof typeof PassiveNames]: PassiveType} = {
    Lord_of_the_Dead: {
    ...
    Successive_Detonations: {
        ...
        url: "",
        icon: "",
        stats: ["20% increased Critical Strike Chance for each Mine Detonated Recently, up to 100%", "+8% to Critical Strike Multiplier for each Mine Detonated Recently, up to 40%"],
    },
    Razor_s_Edge: {
        name: "Razor's Edge",
        url: "/Razor%27s_Edge",
    ...
    Sacrifice: {
        ...
        stats: ["Minions have +10% to all Elemental Resistances", "Minions have 20% increased maximum Life", "Minions Regenerate 1% of Life per second", "Regenerate 1% of Life per second"],
    },
    Command_of_the_Elements: {
    ...
    Arcane_Capacitor: {
        ...
        stats: ["15% increased maximum Mana", "10% chance to gain Arcane Surge when you Kill an Enemy", "10% increased Effect of Arcane Surge on you per", "200 Mana spent Recently, up to 50%"],
    },
    Devotion: {
        name: "Devotion",
        url: "/Devotion",
    ...
    Light_Eater: {
        ...
        stats: ["0.8% of Spell Damage Leeched as Energy Shield", "20% increased Maximum total Recovery per second from Energy Shield Leech", "24% increased Damage while on Full Energy Shield"],
    },
    Retaliation: {
        name: "Retaliation",
        url: "/Retaliation",
    ...
    Gravepact: {
        ...
        stats: ["Minions deal 15% increased Damage", "30% increased Minion Accuracy Rating", "Minions have 8% increased Attack Speed", "Minions have 5% chance to deal Double Damage"],
    },
    Crusader: {
        name: "Crusader",
        url: "/Crusader",
    ...
    Overcharge: {name: "Overcharge", url: "/Overcharge", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/d/d6/Chargeint_passive_skill_icon.png", stats: ["+1 to Maximum Power Charges"]},
    True_Strike: {
        name: "True Strike",
        url: "/True_Strike",
    ...
    Savagery: {name: "Savagery", url: "/Savagery", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/c/c0/Chargedex_passive_skill_icon.png", stats: ["+1 to Maximum Frenzy Charges"]},
    Slaughter: {
        name: "Slaughter",
        url: "/Slaughter",
    ...
    Transcendence: {name: "Transcendence", url: "", icon: "", stats: ["-10 Physical Damage taken from Hits", "-1 Physical Damage taken from Hits per Level"], solo: true},
    Dreamer: {
        name: "Dreamer",
        url: "/Dreamer",
    ...
    High_Explosives: {
        ...
        stats: ["Trap Damage Penetrates 10% Elemental Resistances", "Mine Damage Penetrates 10% Elemental Resistances", "30% increased Trap Trigger Area of Effect", "30% increased Mine Duration"],
    },
    Arcane_Vision: {
        name: "Arcane Vision",
        url: "/Arcane_Vision",
    ...
    Farsight: {
        ...
        stats: ["24% increased Damage with Bows", "24% increased Damage Over Time with Bow Skills", "16% increased Accuracy Rating with Bows", "6% increased Attack Speed with Bows"],
    },
    Ribcage_Crusher: {
    ...
    Divine_Judgement: {
        ...
        stats: ["18% increased Elemental Damage", "Damage Penetrates 5% Elemental Resistances", "+6% to Fire Damage over Time Multiplier", "10% increased Effect of non-Damaging Ailments on Enemies"],
    },
    Potency_of_Will: {
    ...
    Lethality: {
        ...
        stats: ["+30% to Critical Strike Multiplier with Bows", "16% increased Damage with Bows", "50% increased Critical Strike Chance with Bows", "16% increased Damage Over Time with Bow Skills"],
    },
    Grave_Intentions: {
        ...
        stats: ["Minions have +15% to Chaos Resistance", "Minions gain 10% of Maximum Life as Extra Maximum Energy Shield", "Minions have 25% chance to gain Unholy Might for 4 seconds on Kill"],
    },
    Breath_of_Flames: {
    ...
    Berserking: {name: "Berserking", url: "/Berserking", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/b/bc/Berserking_passive_skill_icon.png", stats: ["12% increased Attack Speed"]},
    Fangs_of_Frost: {
        name: "Fangs of Frost",
        url: "/Fangs_of_Frost",
    ...
    Light_of_Divinity: {
        ...
        stats: ["15% increased Spell Damage", "4% increased Cast Speed", "+10 to Strength and Intelligence", "10% increased Light Radius", "20% increased Critical Strike Chance for Spells"],
    },
    Precision: {
        name: "Precision",
        url: "/Precision",
    ...
    Ophidian_Aim: {
        ...
        stats: ["12% increased Accuracy Rating with Staves", "8% increased Attack Speed with Staves", "+150 to Accuracy Rating with Staves", "30% increased Critical Strike Chance with Staves"],
    },
    Path_of_the_Savant: {
    ...
    Endurance: {name: "Endurance", url: "/Endurance", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/7/78/Chargestr_passive_skill_icon.png", stats: ["+1 to Maximum Endurance Charges"]},
    Deep_Thoughts: {
        name: "Deep Thoughts",
        url: "/Deep_Thoughts",
    ...
    Clever_Construction: {
        ...
        stats: ["Traps cannot be Damaged for 5 seconds after being Thrown", "Mines cannot be Damaged for 5 seconds after being thrown", "20% increased Trap Damage", "20% increased Mine Damage"],
    },
    Bloodless: {
        name: "Bloodless",
        url: "/Bloodless",
    ...
    Spiritual_Aid: {
        ...
        stats: ["Increases and Reductions to Minion Damage also affect you", "30% increased Minion Accuracy Rating", "30% increased Global Accuracy Rating", "Minions deal 15% increased Damage"],
    },
    Exceptional_Performance: {
    ...
    Ambidexterity: {
        ...
        stats: ["50% increased Attack Damage with Main Hand", "20% increased Attack Speed with Off Hand", "Attack Skills deal 50% increased Damage with Ailments while Dual Wielding"],
    },
    Tireless: {
        name: "Tireless",
        url: "/Tireless",
    ...
    Vitality_Void: {
        ...
        stats: ["20% increased total Recovery per second from Life Leech", "0.8% of Attack Damage Leeched as Life", "15% increased Maximum total Recovery per second from Life Leech"],
    },
    Spinecruncher: {
        name: "Spinecruncher",
        url: "/Spinecruncher",
    ...
    Nimbleness: {
        ...
        stats: ["6% increased Cast Speed", "4% increased Movement Speed", "15% chance to Avoid interruption from Stuns while Casting", "+12% to Critical Strike Multiplier for Spells"],
    },
    Arcane_Focus: {
        name: "Arcane Focus",
        url: "/Arcane_Focus",
    ...
    Breath_of_Rime: {
        ...
        stats: ["20% increased Freeze Duration on Enemies", "10% chance to Freeze", "20% increased Cold Damage", "15% increased Effect of Chill", "+10% to Cold Damage over Time Multiplier"],
    },
    Thick_Skin: {
        name: "Thick Skin",
        url: "/Thick_Skin",
    ...
    Graceful_Assault: {
        ...
        stats: ["20% increased Attack Damage", "30% increased Evasion Rating during Onslaught", "10% chance to gain Onslaught for 4 seconds on Kill", "20% increased Onslaught Effect"],
    },
    Sleight_of_Hand: {
    ...
    Weapon_Artistry: {
        ...
        stats: ["16% increased Attack Damage", "+2% Chance to Block Attack Damage while Dual Wielding or holding a Shield", "+10 to Strength and Dexterity", "4% increased Attack Speed"],
    },
    Cleaving: {
        name: "Cleaving",
        url: "/Cleaving",
    ...
    Testudo: {
        ...
        url: "/Testudo",
        icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/3/36/Barricade_passive_skill_icon.png",
        stats: ["+5% Chance to Block Attack Damage while holding a Shield", "60% increased Block Recovery", "+20 Mana gained when you Block", "40% increased Defences from Equipped Shield"],
    },
    Revelry: {
        name: "Revelry",
        url: "/Revelry",
    ...
    Thief_s_Craft: {name: "Thief's Craft", url: "/Thief%27s_Craft", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/3/3f/Savant_passive_skill_icon.png", stats: ["+30 to Intelligence"]},
    Blacksmith_s_Clout: {
    ...
    Spirit_Void: {
        ...
        url: "/Spirit_Void",
        icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/e/eb/Minddrinker_passive_skill_icon.png",
        stats: ["20% increased total Recovery per second from Mana Leech", "0.8% of Attack Damage Leeched as Mana", "25% increased Maximum total Recovery per second from Mana Leech"],
    },
    Redemption: {
        name: "Redemption",
        url: "/Redemption",
    ...
    Sanctuary: {
        ...
        icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/3/36/Barricade_passive_skill_icon.png",
        stats: ["+3% Chance to Block Attack Damage while holding a Shield", "+3% Chance to Block Spell Damage while holding a Shield", "+12% Elemental Resistances while holding a Shield"],
    },
    Wisdom_of_the_Glade: {
    ...
    Whirling_Barrier: {
        ...
        stats: ["+6% Chance to Block Attack Damage while wielding a Staff", "+6% Chance to Block Spell Damage while wielding a Staff", "20% chance to gain a Power Charge when you Block"],
    },
    Hatchet_Master: {
        name: "Hatchet Master",
        url: "/Hatchet_Master",
    ...
    Aspect_Of_Stone: {name: "Aspect of Stone", url: "", icon: "", stats: ["20% chance to Avoid Physical Damage from Hits"], solo: true},
    Golem_s_Blood: {
        name: "Golem's Blood",
        url: "/Golem%27s_Blood",
    ...
    Primal_Manifestation: {
        ...
        stats: ["24% increased Totem Damage", "20% increased Totem Life", "20% increased Totem Duration", "24% increased Damage with Brand Skills", "Brand Skills have 20% increased Duration"],
    },
    Agility: {name: "Agility", url: "/Agility", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/c/ce/Grace_passive_skill_icon.png", stats: ["+30 to Dexterity"]},
    Vengeant_Cascade: {
    ...
    Dire_Torment: {name: "Dire Torment", url: "", icon: "", stats: ["30% increased Critical Strike Chance", "+20% to Damage over Time Multiplier for Ailments from Critical Strikes"]},
    Essence_Surge: {
        name: "Essence Surge",
        url: "/Essence_Surge",
    ...
    Galvanic_Hammer: {
        ...
        stats: ["25% increased Elemental Damage with Maces and Sceptres", "10% increased Accuracy Rating with Maces and Sceptres", "Damage with Weapons Penetrates 5% Elemental Resistance"],
    },
    Stamina: {name: "Stamina", url: "/Stamina", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/7/78/Chargestr_passive_skill_icon.png", stats: ["+1 to Maximum Endurance Charges"]},
    Sanctum_of_Thought: {
    ...
    Tenacity: {name: "Tenacity", url: "", icon: "", stats: ["5% increased maximum Life", "Transfiguration of Body"], solo: true},
    Freedom_of_Movement: {
        ...
        stats: ["30% increased Evasion Rating", "10% increased Movement Speed while Phasing", "5% chance to Dodge Attack Hits while Phasing", "10% chance to gain Phasing for 4 seconds on Kill"],
    },
    Adder_s_Touch: {
        name: "Adder's Touch",
        url: "/Adder%27s_Touch",
    ...
    Force_Shaper: {
        ...
        stats: ["20% increased Physical Damage", "Gain 4% of Physical Damage as Extra Chaos Damage", "4% increased Attack and Cast Speed", "10% reduced Physical Damage taken over time"],
    },
    Frenetic: {name: "Frenetic", url: "/Frenetic", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/c/c0/Chargedex_passive_skill_icon.png", stats: ["+1 to Maximum Frenzy Charges"]},
    Essence_Extraction: {
        name: "",
        url: "",
        icon: "",
    ...
    Destructive_Apparatus: {
        ...
        stats: ["20% increased Mine Damage", "10% increased Mine Throwing Speed", "40% increased Mine Duration", "Each Mine applies 2% reduced Damage dealt to Enemies near it, up to 10%"],
    },
    Vigour: {name: "Vigour", url: "/Vigour", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/7/78/Chargestr_passive_skill_icon.png", stats: ["+1 to Maximum Endurance Charges"]},
    Divine_Fervour: {
        name: "Divine Fervour",
        url: "/Divine_Fervour",
    ...
    Aspect_of_the_Eagle: {
        ...
        stats: ["20% increased Damage with Bows", "4% increased Movement Speed", "12% increased Global Accuracy Rating", "+10 to maximum Life", "20% increased Damage Over Time with Bow Skills"],
    },
    Diamond_Skin: {
        name: "Diamond Skin",
        url: "/Diamond_Skin",
    ...
    Inexorable: {
        ...
        stats: ["20% increased Armour", "Regenerate 0.2% of Life per second per Endurance Charge", "10% chance to gain an Endurance Charge when you are Hit", "30% increased Armour while stationary"],
    },
    Breath_of_Lightning: {
    ...
    Fervour: {name: "Fervour", url: "/Fervour", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/c/c0/Chargedex_passive_skill_icon.png", stats: ["+1 to Maximum Frenzy Charges"]},
    Hasty_Reconstruction: {
    ...
    Saboteur: {
        ...
        stats: ["30% increased Trap Damage", "30% increased Mine Damage", "Can have up to 2 additional Traps placed at a time", "Can have up to 2 additional Remote Mines placed at a time"],
    },
    Nightstalker: {
        name: "Nightstalker",
        url: "/Nightstalker",
    ...
    Singular_Focus: {
        ...
        stats: ["Channelling Skills deal 15% increased Damage", "4% additional Physical Damage Reduction while Channelling", "Channelling Skills have 6% increased Attack and Cast Speed"],
    },
    Arcane_Swiftness: {
    ...
    Hard_Knocks: {name: "Hard Knocks", url: "/Hard_Knocks", icon: "https://gamepedia.cursecdn.com/pathofexile_gamepedia/3/3f/Savant_passive_skill_icon.png", stats: ["+30 to Intelligence"]},
    Charging_Offensive: {
...
const Crafting: {[name in keyof typeof PassiveNames]: Array<keyof typeof OilNames | null>} = {
    Lord_of_the_Dead: ["Silver", "Verdant", "Crimson"],
    Path_of_the_Warrior: ["Amber", null, null],
    Instability: ["Silver", "Verdant", null],
    Successive_Detonations: ["Clear", "Crimson", null],
    ...
    Mystic_Bulwark: ["Teal", null, null],
    Command_of_Steel: ["Opalescent", "Amber", "Crimson"],
    Combat_Stamina: ["Clear", "Verdant", "Black"],
    Cloth_and_Chain: ["Clear", "Azure", null],
    Arcane_Capacitor: ["Golden", "Violet", "Black"],
    Devotion: ["Silver", "Crimson", null],
    Righteous_Army: ["Verdant", "Black", null],
    Fending: ["Sepia", "Verdant", null],
    Toxic_Strikes: ["Clear", "Amber", "Crimson"],
    Ravenous_Horde: ["Opalescent", "Verdant", null],
    Efficient_Explosives: ["Sepia", "Teal", "Violet"],
    Fingers_of_Frost: ["Golden", "Violet", "Crimson"],
    Claws_of_the_Magpie: ["Sepia", "Azure", null],
    Retribution: ["Clear", "Opalescent", "Crimson"],
    Spiritual_Command: ["Golden", "Sepia", null],
    Coldhearted_Calculation: ["Crimson", null, null],
    Harvester_of_Foes: ["Amber", "Violet", null],
    Essence_Sap: ["Teal", "Violet", "Black"],
    Eagle_Eye: ["Clear", "Opalescent", null],
    Light_Eater: ["Azure", "Violet", "Crimson"],
    Retaliation: ["Opalescent", "Verdant", "Crimson"],
    Volatile_Mines: ["Opalescent", "Azure", null],
    Arcane_Expanse: ["Golden", "Crimson", null],
    Utmost_Might: ["Amber", "Azure", "Crimson"],
    Bludgeon_Blitz: ["Azure", "Violet", null],
    Faith_and_Steel: ["Golden", "Sepia", "Black"],
    Magmatic_Strikes: ["Sepia", "Crimson", null],
    Born_to_Fight: ["Golden", "Violet", null],
    Quick_Recovery: ["Golden", "Teal", null],
    Master_of_Force: ["Opalescent", "Black", null],
    Claws_of_the_Falcon: ["Golden", "Amber", null],
    Silent_Steps: ["Amber", "Verdant", "Violet"],
    Will_of_Blades: ["Sepia", "Verdant", "Black"],
    Gravepact: ["Azure", "Black", null],
    Crusader: ["Clear", "Golden", null],
    Infused: ["Silver", "Crimson", null],
    Disintegration: ["Violet", "Black", null],
    Overcharge: ["Silver", "Crimson", "Black"],
    True_Strike: ["Teal", "Crimson", "Black"],
    Indomitable_Army: ["Silver", "Violet", "Crimson"],
    Depth_Perception: ["Amber", "Verdant", "Teal"],
    Cursed_Concoction: ["Golden", "Azure", null],
    Dirty_Techniques: ["Silver", "Amber", null],
    Serpent_Stance: ["Opalescent", "Azure", "Black"],
    Master_Sapper: ["Opalescent", "Teal", "Black"],
    Deflection: ["Opalescent", "Sepia", "Teal"],
    Savagery: ["Golden", "Crimson", "Black"],
    Slaughter: ["Azure", null, null],
    Prodigal_Perfection: ["Clear", "Azure", null],
    Aspect_of_the_Panther: ["Sepia", "Azure", null],
    Kinetic_Impacts: ["Amber", "Azure", "Violet"],
    Martial_Experience: ["Clear", "Verdant", "Azure"],
    Ironwood: ["Clear", "Amber", "Teal"],
    Dismembering: ["Opalescent", "Golden", "Violet"],
    Sentinel: ["Verdant", "Teal", "Azure"],
    Explosive_Impact: ["Opalescent", "Verdant", "Azure"],
    Crackling_Speed: ["Opalescent", "Black", null],
    Lava_Lash: ["Clear", "Golden", null],
    Transcendence: ["Clear", "Golden", "Violet"],
    Dreamer: ["Sepia", "Teal", "Azure"],
    Might: ["Clear", "Amber", null],
    Cleansed_Thoughts: ["Clear", "Golden", "Azure"],
    Rampart: ["Golden", "Azure", "Black"],
    Ash_Frost_and_Storm: ["Sepia", "Crimson", null],
    Method_to_the_Madness: ["Silver", "Verdant", "Teal"],
    Way_Of_The_Warrior: ["Golden", "Amber", "Black"],
    Smashing_Strikes: ["Azure", "Violet", null],
    Flaying: ["Clear", "Violet", "Crimson"],
    Destroyer: ["Opalescent", "Sepia", "Verdant"],
    Steadfast: ["Opalescent", "Azure", null],
    Unnatural_Calm: ["Golden", "Verdant", null],
    Shaman_s_Dominion: ["Clear", "Silver", "Azure"],
    Versatility: ["Opalescent", "Verdant", null],
    Shamanistic_Fury: ["Sepia", "Amber", "Violet"],
    Stun_Mastery: ["Golden", "Sepia", "Amber"],
    Mind_Drinker: ["Verdant", "Teal", null],
    Honed_Edge: ["Sepia", "Azure", "Violet"],
    High_Explosives: ["Silver", "Verdant", null],
    Arcane_Vision: ["Clear", "Amber", "Verdant"],
    Divine_Wrath: ["Opalescent", "Amber", null],
    Mysticism: ["Opalescent", "Teal", "Violet"],
    Stabbing_Thirst: ["Silver", "Sepia", null],
    Unstable_Munitions: ["Teal", "Violet", null],
    Farsight: ["Verdant", "Crimson", null],
    Ribcage_Crusher: ["Teal", "Black", null],
    Divine_Judgement: ["Sepia", "Teal", "Black"],
    Potency_of_Will: ["Opalescent", "Sepia", null],
    Druidic_Rite: ["Clear", "Golden", "Crimson"],
    Executioner: ["Amber", "Verdant", "Azure"],
    Finesse: ["Teal", "Azure", "Black"],
    Heart_of_Oak: ["Golden", "Verdant", "Crimson"],
    Winter_Spirit: ["Silver", "Sepia", "Teal"],
    Tempest_Blast: ["Silver", "Amber", "Verdant"],
    Written_in_Blood: ["Golden", "Sepia", "Violet"],
    Path_of_the_Hunter: ["Clear", "Verdant", null],
    Hex_Master: ["Opalescent", "Crimson", "Black"],
    Adamant: ["Azure", "Violet", "Black"],
    Fangs_of_the_Viper: ["Silver", "Golden", "Sepia"],
    Sanctity: ["Azure", "Black", null],
    Warrior_s_Blood: ["Teal", "Black", null],
    Discipline_and_Training: ["Silver", "Black", null],
    Melding: ["Opalescent", "Sepia", "Violet"],
    Corruption: ["Crimson", "Black", null],
    Ballistic_Mastery: ["Opalescent", "Azure", "Violet"],
    Sovereignty: ["Silver", null, null],
    Disciple_of_the_Slaughter: ["Golden", "Amber", "Verdant"],
    Barbarism: ["Opalescent", "Golden", null],
    Lethality: ["Silver", "Sepia", "Violet"],
    Grave_Intentions: ["Sepia", "Violet", null],
    Breath_of_Flames: ["Golden", "Verdant", "Azure"],
    Swagger: ["Golden", "Black", null],
    Ancestral_Knowledge: ["Clear", "Sepia", "Verdant"],
    Prism_Weave: ["Opalescent", "Sepia", null],
    Steelwood_Stance: ["Teal", "Azure", null],
    Precise_Interception: ["Verdant", "Crimson", "Black"],
    Blunt_Trauma: ["Silver", "Teal", "Crimson"],
    One_with_the_River: ["Opalescent", "Teal", null],
    Arcane_Will: ["Opalescent", "Golden", "Amber"],
    Divine_Fury: ["Amber", "Black", null],
    Berserking: ["Clear", "Opalescent", "Sepia"],
    Fangs_of_Frost: ["Silver", "Sepia", null],
    Light_of_Divinity: ["Violet", "Crimson", null],
    Precision: ["Amber", "Black", null],
    Poisonous_Fangs: ["Clear", "Amber", "Azure"],
    Ophidian_Aim: ["Clear", "Teal", "Crimson"],
    Path_of_the_Savant: ["Sepia", "Amber", "Verdant"],
    Juggernaut: ["Opalescent", "Amber", "Teal"],
    Aggressive_Bastion: ["Verdant", "Violet", "Black"],
    Blade_Barrier: ["Clear", "Opalescent", "Violet"],
    Fatal_Blade: ["Opalescent", "Amber", null],
    Art_of_the_Gladiator: ["Opalescent", "Golden", "Sepia"],
    Mystic_Talents: ["Opalescent", "Silver", "Amber"],
    Endurance: ["Clear", "Golden", "Black"],
    Deep_Thoughts: ["Clear", "Verdant", "Violet"],
    Deadly_Inclinations: ["Golden", "Verdant", "Black"],
    Heavy_Draw: ["Sepia", "Verdant", "Violet"],
    Runesmith: ["Silver", "Azure", "Crimson"],
    Fury_Bolts: ["Verdant", "Teal", null],
    Elemental_Focus: ["Sepia", "Amber", "Azure"],
    Clever_Construction: ["Sepia", "Azure", "Crimson"],
    Bloodless: ["Golden", "Amber", "Crimson"],
    Blast_Cascade: ["Silver", "Amber", "Crimson"],
    Spiritual_Aid: ["Silver", "Golden", null],
    Exceptional_Performance: ["Clear", "Amber", "Black"],
    Whispers_of_Doom: ["Golden", "Black", null],
    Purity_of_Flesh: ["Clear", "Silver", "Black"],
    Battle_Rouse: ["Sepia", "Verdant", "Azure"],
    Ambidexterity: ["Amber", "Azure", "Black"],
    Tireless: ["Opalescent", null, null],
    Vitality_Void: ["Clear", "Silver", "Golden"],
    Spinecruncher: ["Verdant", "Violet", null],
    Influence: ["Golden", "Verdant", "Teal"],
    Swift_Skewering: ["Silver", "Violet", null],
    Wrecking_Ball: ["Clear", "Opalescent", "Teal"],
    Battle_Cry: ["Opalescent", "Sepia", "Azure"],
    Primeval_Force: ["Silver", "Azure", "Violet"],
    Nimbleness: ["Amber", "Crimson", null],
    Arcane_Focus: ["Verdant", "Crimson", null],
    Dazzling_Strikes: ["Opalescent", "Teal", null],
    Arcane_Potency: ["Silver", "Azure", "Black"],
    Doom_Cast: ["Golden", "Amber", "Azure"],
    Leadership: ["Opalescent", "Silver", "Violet"],
    Weathered_Hunter: ["Sepia", "Amber", "Teal"],
    Breath_of_Rime: ["Silver", "Teal", null],
    Thick_Skin: ["Silver", "Violet", null],
    Bravery: ["Opalescent", "Violet", null],
    Graceful_Assault: ["Violet", "Black", null],
    Sleight_of_Hand: ["Opalescent", "Verdant", "Teal"],
    Claws_of_the_Hawk: ["Opalescent", "Violet", "Black"],
    Blast_Radius: ["Clear", "Opalescent", "Verdant"],
    Avatar_of_the_Hunt: ["Clear", "Opalescent", null],
    Feller_of_Foes: ["Opalescent", "Amber", "Black"],
    Snowforged: ["Sepia", "Azure", "Black"],
    Prowess: ["Clear", "Verdant", null],
    Twin_Terrors: ["Clear", "Azure", "Black"],
    Disciple_Of_The_Forbidden: ["Black", null, null],
    Hematophagy: ["Silver", "Violet", "Black"],
    Master_Fletcher: ["Sepia", "Verdant", "Crimson"],
    Harrier: ["Azure", "Crimson", null],
    Defiance: ["Amber", "Teal", "Black"],
    Golem_Commander: ["Silver", "Golden", "Azure"],
    Practical_Application: ["Clear", "Violet", null],
    Death_Attunement: ["Clear", "Silver", "Crimson"],
    Heart_of_Thunder: ["Golden", "Sepia", "Azure"],
    Trickery: ["Verdant", "Black", null],
    Shaper: ["Clear", "Crimson", null],
    Arcane_Guarding: ["Clear", "Teal", "Black"],
    Heartseeker: ["Teal", "Crimson", null],
    Weapon_Artistry: ["Clear", "Amber", "Violet"],
    Cleaving: ["Sepia", "Amber", "Black"],
    Disemboweling: ["Golden", "Verdant", "Violet"],
    Aspect_of_the_Lynx: ["Violet", "Crimson", null],
    Blade_of_Cunning: ["Silver", "Sepia", "Azure"],
    Coordination: ["Amber", "Crimson", "Black"],
    Testudo: ["Clear", "Sepia", "Black"],
    Revelry: ["Amber", "Violet", "Black"],
    Annihilation: ["Clear", "Black", null],
    Reflexes: ["Amber", "Verdant", "Black"],
    Hardened_Scars: ["Golden", "Teal", "Black"],
    Proficiency: ["Sepia", "Amber", null],
    Enigmatic_Reach: ["Verdant", "Teal", "Black"],
    Soul_of_Steel: ["Golden", null, null],
    Static_Blows: ["Teal", "Violet", "Crimson"],
    Thief_s_Craft: ["Clear", "Sepia", "Amber"],
    Blacksmith_s_Clout: ["Opalescent", "Verdant", "Black"],
    Holy_Dominion: ["Azure", "Crimson", null],
    Void_Barrier: ["Silver", "Golden", "Crimson"],
    Skittering_Runes: ["Opalescent", "Silver", null],
    Butchery: ["Verdant", "Violet", "Crimson"],
    Constitution: ["Silver", "Golden", null],
    Revenge_of_the_Hunted: ["Silver", "Golden", "Black"],
    Utmost_Intellect: ["Amber", "Violet", "Crimson"],
    Spirit_Void: ["Verdant", null, null],
    Redemption: ["Sepia", "Violet", "Crimson"],
    Champion_of_the_Cause: ["Golden", "Teal", "Crimson"],
    Splitting_Strikes: ["Clear", "Teal", "Violet"],
    Devastating_Devices: ["Silver", "Teal", null],
    Forceful_Skewering: ["Verdant", "Azure", "Violet"],
    Flash_Freeze: ["Verdant", "Azure", "Crimson"],
    Sanctuary: ["Amber", "Teal", null],
    Wisdom_of_the_Glade: ["Clear", "Amber", null],
    ...
    Wandslinger: ["Teal", "Crimson", null],
    Atrophy: ["Clear", "Golden", "Sepia"],
    Storm_Weaver: ["Sepia", "Crimson", "Black"],
    Heart_of_Flame: ["Golden", "Teal", "Azure"],
    Elder_Power: ["Teal", "Violet", null],
    Lust_for_Carnage: ["Opalescent", "Golden", "Teal"],
    Hired_Killer: ["Opalescent", "Violet", null],
    Utmost_Swiftness: ["Sepia", "Teal", "Crimson"],
    Aspect_Of_Stone: ["Golden", "Violet", null],
    Golem_s_Blood: ["Golden", "Teal", null],
    Enigmatic_Defence: ["Violet", null, null],
    Tranquility: ["Golden", "Azure", null],
    Primal_Manifestation: ["Amber", "Verdant", "Crimson"],
    Agility: ["Clear", "Sepia", null],
    Vengeant_Cascade: ["Golden", "Amber", null],
    Herbalism: ["Opalescent", "Silver", "Teal"],
    Thunderous_Salvos: ["Golden", "Sepia", null],
    Claws_of_the_Pride: ["Amber", "Violet", null],
    Bladedancer: ["Amber", "Crimson", null],
    Blast_Waves: ["Clear", "Verdant", "Crimson"],
    Entropy: ["Sepia", "Amber", "Crimson"],
    Arcing_Blows: ["Clear", "Silver", null],
    Deep_Wisdom: ["Sepia", "Teal", null],
    Insightfulness: ["Golden", "Verdant", null],
    Assassination: ["Opalescent", "Golden", "Black"],
    Longshot: ["Opalescent", "Teal", "Crimson"],
    Dire_Torment: ["Opalescent", "Azure", "Crimson"],
    Essence_Surge: ["Silver", "Golden", "Teal"],
    Galvanic_Hammer: ["Clear", "Sepia", "Crimson"],
    Stamina: ["Silver", "Black", null],
    Sanctum_of_Thought: ["Sepia", "Black", null],
    Resourcefulness: ["Silver", "Golden", "Verdant"],
    Ethereal_Feast: ["Silver", "Golden", "Amber"],
    Blood_Drinker: ["Opalescent", "Silver", null],
    Heart_of_Ice: ["Opalescent", "Golden", "Crimson"],
    Soul_Siphon: ["Golden", "Teal", "Violet"],
    Tenacity: ["Golden", "Crimson", null],
    Freedom_of_Movement: ["Clear", "Sepia", "Violet"],
    Adder_s_Touch: ["Opalescent", "Sepia", "Black"],
    Piercing_Shots: ["Opalescent", "Silver", "Black"],
    Dervish: ["Azure", "Crimson", "Black"],
    Crystal_Skin: ["Silver", "Sepia", "Black"],
    Force_Shaper: ["Opalescent", "Golden", "Azure"],
    Frenetic: ["Silver", "Azure", null],
    Essence_Extraction: ["Crimson", "Black", null],
    Destructive_Apparatus: ["Silver", "Sepia", "Amber"],
    Vigour: ["Opalescent", "Crimson", null],
    Divine_Fervour: ["Opalescent", "Silver", "Verdant"],
    Enduring_Bond: ["Clear", "Golden", "Verdant"],
    Red_Storm: ["Teal", "Azure", null],
    Forces_of_Nature: ["Silver", "Verdant", "Azure"],
    Mana_Flows: ["Clear", "Opalescent", "Golden"],
    Foresight: ["Opalescent", "Golden", "Verdant"],
    Pain_Forger: ["Clear", "Violet", null],
    Soul_Thief: ["Opalescent", "Sepia", "Crimson"],
    Arsonist: ["Verdant", "Azure", null],
    Fire_Walker: ["Violet", "Crimson", "Black"],
    Expertise: ["Sepia", null, null],
    Physique: ["Clear", "Teal", null],
    Arcane_Chemistry: ["Golden", "Amber", "Teal"],
    Counterweight: ["Clear", "Silver", "Amber"],
    Gemini: ["Amber", "Teal", "Violet"],
    Arcanist_s_Dominion: ["Clear", "Crimson", "Black"],
    Lightning_Walker: ["Sepia", "Black", null],
    Brutal_Blade: ["Golden", "Sepia", "Verdant"],
    Aspect_of_the_Eagle: ["Amber", "Verdant", null],
    Diamond_Skin: ["Clear", "Sepia", "Teal"],
    Strong_Arm: ["Clear", "Opalescent", "Azure"],
    Bone_Breaker: ["Verdant", "Azure", null],
    Totemic_Zeal: ["Verdant", "Violet", null],
    Mental_Rapidity: ["Sepia", "Violet", "Black"],
    Decay_Ward: ["Sepia", "Verdant", "Teal"],
    Quickstep: ["Amber", "Verdant", null],
    Inexorable: ["Opalescent", "Silver", "Crimson"],
    Breath_of_Lightning: ["Golden", "Azure", "Violet"],
    Overcharged: ["Clear", "Opalescent", "Silver"],
    Fleetfoot: ["Opalescent", "Sepia", "Amber"],
    Disciple_of_the_Unyielding: ["Opalescent", "Violet", "Crimson"],
    Holy_Fire: ["Silver", "Amber", "Teal"],
    Righteous_Decree: ["Sepia", "Teal", null],
    Lucidity: ["Silver", "Amber", "Violet"],
    Thrill_Seeker: ["Amber", "Teal", null],
    Titanic_Impacts: ["Opalescent", "Amber", "Verdant"],
    Alacrity: ["Clear", null, null],
    Explosive_Runes: ["Amber", "Azure", null],
    Fatal_Toxins: ["Clear", "Silver", "Violet"],
    Charisma: ["Opalescent", "Golden", null],
    Fearsome_Force: ["Teal", "Azure", "Crimson"],
    Dark_Arts: ["Opalescent", "Teal", "Azure"],
    Aqueous_Accelerant: ["Golden", "Amber", "Violet"],
    Heart_of_the_Warrior: ["Silver", "Golden", "Violet"],
    Beef: ["Clear", "Sepia", null],
    Soul_Raker: ["Silver", "Sepia", "Verdant"],
    Words_of_Glory: ["Clear", "Teal", "Azure"],
    Master_of_the_Arena: ["Opalescent", "Silver", "Sepia"],
    Amplify: ["Opalescent", "Amber", "Azure"],
    Blade_Master: ["Clear", "Silver", "Sepia"],
    Throatseeker: ["Opalescent", "Amber", "Violet"],
    Heart_and_Soul: ["Golden", "Sepia", "Crimson"],
    Survivalist: ["Golden", "Azure", "Crimson"],
    Primal_Spirit: ["Silver", "Amber", null],
    Blood_Siphon: ["Opalescent", "Silver", "Azure"],
    Skull_Cracking: ["Clear", "Opalescent", "Black"],
    Searing_Heat: ["Silver", "Amber", "Azure"],
    Frost_Walker: ["Opalescent", "Verdant", "Violet"],
    Cruel_Preparation: ["Silver", "Teal", "Black"],
    Deadly_Draw: ["Silver", "Sepia", "Crimson"],
    Profane_Chemistry: ["Silver", "Verdant", "Black"],
    Unpredictable_Offensive: ["Amber", "Teal", "Azure"],
    Bloodletting: ["Silver", "Azure", null],
    Fervour: ["Silver", "Amber", "Black"],
    Hasty_Reconstruction: ["Amber", "Azure", null],
    King_of_the_Hill: ["Silver", "Verdant", "Violet"],
    Dynamo: ["Clear", "Sepia", "Azure"],
    Solidity: ["Clear", "Verdant", "Teal"],
    Fusillade: ["Sepia", "Verdant", null],
    Saboteur: ["Clear", "Teal", null],
    Nightstalker: ["Golden", "Sepia", "Teal"],
    Backstabbing: ["Clear", "Silver", "Teal"],
    Growth_and_Decay: ["Clear", "Golden", "Teal"],
    Swift_Venoms: ["Clear", "Golden", "Amber"],
    Singular_Focus: ["Opalescent", "Crimson", null],
    Arcane_Swiftness: ["Clear", "Silver", null],
    Lethal_Assault: ["Clear", "Black", null],
    Brinkmanship: ["Clear", "Opalescent", "Amber"],
    Hard_Knocks: ["Sepia", "Amber", null],
    Charging_Offensive: ["Silver", "Teal", "Violet"],
    Aligned_Spirits: ["Sepia", "Violet", null],
    Gladiator_s_Perseverance: ["Silver", "Teal", "Azure"],
    Hunter_s_Gambit: ["Clear", "Silver", "Verdant"],
};
